...
void setup(){
   ...
   //kalder objekternes konstruktøre
   helt = new brandmand(); 
   vaeg = new Labyrint(); 
   knap = new Knap();
   brand = new ild();
...
void draw() {
 ...
 // opdeling af levels   
    switch (gameLevel) { 
    case 1:
      brand2.tegnIld(250, 150, x, y, vandStartet, countDown);
      brand4.tegnIld(420, 290, x, y, vandStartet, countDown);
      brand5.tegnIld(100, 420, x, y, vandStartet, countDown);
      brand7.tegnIld(560, 450, x, y, vandStartet, countDown);
    ...
    case 2:
      ...
      brandNextLevel1.tegnIld(250, 150, x, y, vandStartet, countDown);
      brandNextLevel2.tegnIld(420, 290, x, y, vandStartet, countDown);
      brandNextLevel3.tegnIld(100, 420, x, y, vandStartet, countDown);
      brandNextLevel4.tegnIld(560, 450, x, y, vandStartet, countDown);
      brandNextLevel5.tegnIld(560, 100, x, y, vandStartet, countDown);
